...
def cwt_filtering(listin, samplingrate):
    ...
    mycwtmatr = rowcal(cwtmatr, myguasswindow)
    result = pycwt.icwt(mycwtmatr, result[1], 1 / sr).real
    return result, mycwtmatr, cwtmatr